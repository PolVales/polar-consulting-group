...
const LIGHT_STYLE = `
  ...
  .cta-final{margin:30px 18px 70px;padding:90px 0;background:var(--gold);border-radius:34px}.cta-final p{color:var(--ink)}.cta-final .gold{color:var(--ink);text-decoration:underline;text-decoration-color:var(--coral);text-decoration-thickness:.12em;text-underline-offset:.08em}.cta-final .btn-gold{background:var(--ink);color:#fff;box-shadow:none}.cta-final .btn-ghost{background:transparent}.glow{display:none}
...
function page(lang){
  ...
  '<section class="maresme" id="maresme"><div class="wrap people-band"><div><h2 class="rv">'+t.mar_h+'</h2><p class="rv">'+t.mar_p+'</p><div class="towns rv">'+towns+'</div></div><img src="/europe-conversation.jpg" alt="A technology strategy conversation overlooking Barcelona" class="people-photo rv" loading="lazy" width="1600" height="1067"></div></section>\n'+
