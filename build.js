...
const STYLE = `
  :root{--ink:#0C0C0D;--ink2:#141416;--surf:#181819;--line:rgba(247,245,241,.10);--bone:#F7F5F1;--stone:#9A9893;--stone2:#6E6C68;--gold:#fff200;--r:14px;--maxw:1180px}
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .btn-gold:hover{background:#ffff5c}
  ...
  .svc::before{content:"";position:absolute;inset:0;background:radial-gradient(420px 200px at var(--mx,50%) var(--my,0%),rgba(255,242,0,.12),transparent 70%);opacity:0;transition:opacity .4s}
  .svc:hover{transform:translateY(-6px);border-color:rgba(255,242,0,.45)}
  ...
  .glow{position:absolute;width:min(560px,90vw);height:min(560px,90vw);left:50%;top:50%;transform:translate(-50%,-50%);background:radial-gradient(circle,rgba(255,242,0,.15),transparent 62%);z-index:-1;pointer-events:none}
...
(function(){
  ...
  var W,H,DPR,blobs=[],stars=[],pal=[[255,242,0],[220,209,0],[120,150,200],[230,225,215]];
